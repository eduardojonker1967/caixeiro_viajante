...
Visible files: Agent_video_Pippit_20260430124751.mp4, Dockerfile, PARALELISMO_TSP_2026-06-21_15h56m53s.pdf, README.md, README_PARALELISMO.md, RELATORIO_GERENCIAL.md, RELATORIO_GERENCIAL.pdf, RELATORIO_GERENCIAL_2026-04-28_07h36m47s.pdf, RELATORIO_GERENCIAL_2026-04-28_07h40m52s.pdf, RELATORIO_GERENCIAL_2026-04-28_09h16m19s.md
...
TSP Distância Aleatória (km): 3501.27
TSP Distância NN (km): 1680.85
TSP Distância 2-opt (km): 1450.11
TSP Redução (%): 58.58
TSP Tempo (s): 0.1587
Monte Carlo Custo Atual (R$): 650.02
Monte Carlo Custo Modelo (R$): 366.54
Monte Carlo Economia (%): 43.61
Monte Carlo Iterações: 1000000
Monte Carlo Tempo (s): 0.0922
</environment_details>
...
======================================================================
TABELA 1: RESULTADOS DO TSP - TRAVELING SALESMAN PROBLEM
Projeto: Roteirizador Preditivo de Santa Catarina
======================================================================
...
RESUMO EXECUTIVO:
----------------------------------------------------------------------
Distância Rota Aleatória (Baseline):      3501.27 km
Distância Rota Otimizada (TSP):          1450.11 km
Redução Absoluta:                         2051.16 km
Redução Percentual:                         58.58 %
Fator de Melhoria:                           2.41 x
...
4. **Otimização Simulated Annealing** (1450.11 km): Busca local probabilística
...
4. **Validação Estatística (Monte Carlo)**
   ...
   - Confirma economia de 44% por roteamento otimizado
