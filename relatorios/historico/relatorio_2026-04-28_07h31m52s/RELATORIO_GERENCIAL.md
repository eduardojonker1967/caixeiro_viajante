...
*Relatório gerado em: 28/04/2026 às 07:31:51*
...
**Insight Estatístico:**
- **Volume Total Projetado (120 dias):** **207,984 unidades**.
- **Média Diária Projetada (120 dias):** **1,733 unidades/dia**.
Esta projeção de longo prazo é crucial para decisões de contratação, aquisição de frota e expansão de infraestrutura.
