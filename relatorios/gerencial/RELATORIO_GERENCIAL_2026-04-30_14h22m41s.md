...
*Gerado em: 2026-04-30 14:22:41.497168*
...
```python
        print(f"Lendo base de dados real: {caminho_arquivo}")
...
# Pesos atualizados: Volume (15%), Tipo (25%), Performance (20%), Logística (20%), Carbono (20%)
df_final['IPL'] = (
